          ...
          <div className="glass-card rounded-2xl p-7 premium-border-glow animate-slide-up stagger-1">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div className="space-y-2">
                ...
                />
                {isIOS && (
                  <p className="text-[11px] text-muted-foreground/70 leading-relaxed" data-testid="text-ios-signin-note">
                    Use email &amp; password to sign in on iOS. Visit <span className="text-primary">guberapp.app</span> for additional sign-in options.
                  </p>
                )}
              </div>
