          ...
          <div className="glass-card rounded-2xl p-7 premium-border-glow animate-slide-up stagger-1">
            ...
            {isIOS && isNative && (
              <>
                <Button
                  type="button"
                  className="w-full h-12 rounded-xl font-display text-sm tracking-wider flex items-center justify-center gap-3 bg-white text-black hover:bg-white/90 transition-all mb-2"
                ...
                <p className="text-center text-[11px] text-muted-foreground/70 mb-5 leading-relaxed" data-testid="text-apple-signin-helper">
