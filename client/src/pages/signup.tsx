...
export default function Signup() {
  ...
  // rapid double-tap can race past the `googleLoading` check before the first
  // setState commits. The ref blocks re-entry within the same JS turn.
  ...
  const handleGoogleSignIn = async () => {
    ...
    // Use a ref (not state) because the very first await below races state updates.
        ...
        <div className="glass-card rounded-2xl p-7 premium-border-glow animate-slide-up stagger-1">
          {!isIOS && (
            <>
              ...
              {isNative && (
                <p className="text-center text-[11px] text-muted-foreground/70 mt-2 leading-relaxed" data-testid="text-google-helper">
