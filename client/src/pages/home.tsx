...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col" data-testid="page-home">
      ...
      {/* ── Hero ── */}
      <section className="relative z-10 flex flex-col items-center text-center px-5 pt-12 pb-10 max-w-3xl mx-auto w-full">
        <div className="inline-flex items-center gap-2 rounded-full px-4 py-1.5 mb-8 text-[10px] font-display tracking-widest"
          style={{ background: "rgba(0,229,118,0.08)", border: "1px solid rgba(0,229,118,0.25)", color: "#00e576" }}>
          <Zap className="w-3 h-3" />
          FREE ACCOUNT · NO CREDIT CARD · NO RESUME NEEDED
        </div>

        <h1 className="font-display font-black tracking-tight leading-[1.05] mb-4 text-[clamp(1.85rem,7vw,3.25rem)]">
          Claim Your Spot<br />
          <span style={{ color: "hsl(152 100% 44%)" }}>on the Grid.</span>
        </h1>

        <p className="text-base sm:text-lg max-w-lg leading-relaxed mb-3 text-foreground/80">
          Your local GUBER network is activating. As more people join your area, more jobs, cash drops, and opportunities appear on the map.
        </p>

        {/* Three benefit bullets */}
        <div className="w-full max-w-md mx-auto mb-8 space-y-2 text-left">
          <a
            href="/day1og.html"
            target="_blank"
          ...
          <div className="flex items-start gap-3 rounded-xl px-4 py-3"
            style={{ background: "rgba(0,229,118,0.05)", border: "1px solid rgba(0,229,118,0.15)" }}>
            <MapPin className="w-4 h-4 text-emerald-400 mt-0.5 shrink-0" />
            <div>
              <p className="text-[11px] font-display font-black text-white tracking-wide">🗺️ SECURE YOUR USERNAME</p>
              <p className="text-[10px] text-muted-foreground mt-0.5">Before your area fills up — your identity on the local grid</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3 rounded-xl px-4 py-3"
            ...
            <div>
              <p className="text-[11px] font-display font-black text-white tracking-wide">🎯 FIRST ACCESS TO LOCAL OPPORTUNITIES</p>
              <p className="text-[10px] text-muted-foreground mt-0.5">Jobs, cash drops &amp; gigs in your area — be first in line</p>
            </div>
          </div>
        </div>
        ...
        <Link
          href="/login"
          className="text-[11px] font-display tracking-[0.18em] text-muted-foreground hover:text-foreground transition-colors mb-8"
        ...
        <div className="flex items-center justify-center gap-4 sm:gap-6 flex-wrap text-[11px] font-display tracking-wider"
