    ...
    >
      <div
        ...
        style={{
          ...
          border: "1.5px solid rgba(0,229,118,0.55)",
        }}
      >
        ...
        <div className="rounded-2xl p-4 space-y-2" style={{ background: "rgba(255,255,255,0.03)", border: "1px solid rgba(0,229,118,0.55)" }}>
