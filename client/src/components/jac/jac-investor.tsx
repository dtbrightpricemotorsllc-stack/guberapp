 ...
 *
 * Same JAC identity, Investor operating mode.
 * Uses /api/jac/onboard with mode:"investor".
 * Handles lead capture when tracking.investorLead.complete is returned.
 */

import { useState, useRef, useEffect, useCallback } from "react";
import { Mic, Send, X, ChevronDown, ChevronUp, Loader2 } from "lucide-react";
    ...
    <div data-testid="jac-investor-panel">
        ...
        >
          ...
          <div className="flex-1 text-center sm:text-left">
            ...
            <p className="text-sm leading-relaxed" style={{ color: "#a8a8b3" }}>
              Ask about GUBER, explore the opportunity, or connect with the founder — all in one conversation.
            </p>
          </div>
      ...
      {open && (
        <div
          ...
          style={{ borderColor: "rgba(209,0,255,0.25)", background: "rgba(7,4,16,0.97)", minHeight: 520 }}
        ...
        >
          ...
          {/* Messages */}
          <div className="flex-1 overflow-y-auto px-4 py-4 space-y-4" style={{ maxHeight: 420 }}>
            {messages.map((m, i) => (
          ...
          {/* Quick chips (only when first message) */}
          {messages.length <= 1 && (
